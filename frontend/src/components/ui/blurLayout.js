...
export default function BlurLayout() { 
    ...
    return (
        <div className="w-full relative">
            ...
            <div class="absolute top-48 left-20 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        </div>
    );
}